    ...
    <jet-form-section @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <components-select id="locale" type="text" class="mt-1 block w-full" v-model="form.locale" :options="localeOptions" />
...
<script>
    ...
    import ComponentsSelect from '@/Components/Select'
    ...
    export default {
        ...
        data() {
            return {
                ...
                photoPreview: null,
                localeOptions: [
                    { key: 'en', value: this.__('English') },
                    { key: 'pt-br', value: this.__('Portuguese') },
                ],
            }
        },
